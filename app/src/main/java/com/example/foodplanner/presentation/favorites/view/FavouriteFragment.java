...
import com.example.foodplanner.presentation.favorites.presenter.FavouritePresenter;
import com.example.foodplanner.presentation.favorites.presenter.FavouritePresenterImp;
...
public class FavouriteFragment extends Fragment implements ViewFavourite {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        presenter = new FavouritePresenterImp(this, getContext());
    }
    ...
    public void showAlertDialog(FavoriteMealEntity meal) {
        new AlertDialog.Builder(requireContext())
                .setTitle("Remove From Favorites")
                .setMessage("You are removing this meal from Favorites, Are you sure?")
                .setPositiveButton("Remove", (dialog, which) -> presenter.removeFavorite(meal))
